...
- Say something like: "I'd love to get you on our team's calendar for a free 15-minute benefits analysis — no obligation at all. Want me to send you the booking link?"
...
IMPORTANT: Never make up specific numbers, savings amounts, or plan details that aren't in the facts above. If unsure, say Chase can walk them through specifics on a call.`;
  ...
  function buildWidget() {
    ...
    renderQuickReplies();
    addBotMessage("Hi there! 👋 I'm Avery, a benefits specialist with Ascend Benefits Consulting Group. I can help answer questions about your coverage options, see how much you might save, or get you booked with a team member for a free analysis. What can I help you with today?");
  }
